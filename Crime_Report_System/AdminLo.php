...
if($_SERVER['REQUEST_METHOD'] == "POST"){
  if(empty(trim($_POST['adminname'])) || empty(trim($_POST['password'])))
  {
    $err = "Please enter correct adminname and password";
  }
  else{
  ...
  if(empty($err)){
    $sql = "SELECT id, adminname, password FROM admin_users WHERE adminname = ?";
...
<html lang="en">
  <head>
    ...
    <link href="C:\xampp\htdocs\Crime_Report_System\Admin.php ">
    <link href="C:\xampp\htdocs\Crime_Report_System\Home.html ">
    <title>Crime Reporting Portal</title>
    <link rel="stylesheet" href="styleALo.css">
...
<form action="" method="post">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label" style= color:white>Adminname</label>
    <input type="email" class="form-control" name="adminname" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Username">
