...
<form action ="" method = "post" class="row g-3">
  ...
  <div class="col-md-6">
    ...
    <input type="password" class="form-control" name="password" id="inputPassword" placeholder="Enter Pasword">
  </div>
  <div class="col-12">
    <label for="inputPassword2" class="form-label" style= color:white >Confirm Password</label>
    <input type="password" class="form-control" name="confirm_password" id="inputPassword2" placeholder="Enter Password Again">
  </div>
  <div class="col-md-6">
  ...
  <div class="col-md-2">
    ...
    <input type="tel" class="form-control" name="mobileno" id="inputMob" placeholder="Enter Mobile Number">
  </div>
  <div class="col-12">
